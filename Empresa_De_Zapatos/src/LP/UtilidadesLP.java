 ...
 * sencilla. Posee distintos m�todos p�blicos y est�ticos (por lo tanto no se
 * necesita un objeto como tal para acceder a ellos) para la lectura de los
 * tipos de datos b�sicos en Java. Adem�s, todos los m�todos tienen un control
 * de errores mediante petici�n sucesiva de introducci�n de dato hasta que estos
 * sean correctos.
 */
public class UtilidadesLP {
	/**
	 * Permite introducir por teclado en la consola un n�mero entero (32 bits =
	 * -2147483648 hasta 2147483648) realizando las comprobaciones pertienentes.
	 * 
	 ...
	 * lascomprobaciones pertienentes.
	 * 
	...
	/**
	 * Permite introducir por teclado en la consola un caracter (8 bits = -128 hasta
