...
/**
 * Interfaz para la independencia entre la LN y la LP. Implementados los dos
 * ultimos metodos por nosotros.
 * 
 * @author javier.cerro
 * 
 */
public interface ItfProperty {
	...
	/**
	 * Devuelve la propiedad solicitada por nombre de tipo Date. Implementado por
	 * nosotros para el uso de fechas.
	 * 
	 * @param propiedad nombre de la propiedad a devolver del objeto.
	 * @return genera return
	 */
	...
	/**
	 * Devuelve la propiedad solicitada por nombre de tipo Boolean. Implementado por
	 * nosotros para el uso de fechas.
	 * 
	 * @param propiedad nombre de la propiedad a devolver del objeto.
	 * @return genera return
